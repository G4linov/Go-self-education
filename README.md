...
7. [ ] (les7) Panic и их обработка  
8. [ ] (les8) Обработка ошибок  
9. [ ] (les9) Продвинутая работа с ошибками  
### Модули и пакеты (Modules_and_packages)
1. [ ] (les1) Области видимости, инициализация через init() 
2. [ ] (les2) Работа с зависимостями, go mod 
3. [ ] (les3) Создание модулей и их версионирование 
4. [ ] (les4) layout проекта (структура проекта) 
